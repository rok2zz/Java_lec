...
public class MethodOfString {
	public static void main(String[] args) {
		...
		//3. 문자열 변홤 및 연결 (String.valueOf(), cacat()) 
		// String.valueOf (기본자료형)  : 기본자료형 ==> String 으로 변환 
		String str3 = String.valueOf(2.3);  //실수 2.3을 String형으로 변환
		String str4 = String.valueOf(false);	// 불리언타입 false 을 String 으로 변환
		...
		String str6 = "안녕" + 3;  // 안녕3, + : 연산자를 사용할때 자동 변화 
